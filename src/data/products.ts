...
const RAW_PRODUCTS: Product[] = [
  ...
  // 2. Pure Ceylon Cinnamon Leaf Oil (Type: multi_variant_volume, Unit: Bottles, Variants: 15ml, 30ml, 50ml, 100ml)
  {
    ...
    description: '100% pure steam hydro-distilled Ceylon Cinnamon Leaf Oil from Southern Sri Lanka estates. Rich in natural active Eugenol and antioxidants. Available in 15ml, 30ml, 50ml, and 100ml amber dropper bottles.',
