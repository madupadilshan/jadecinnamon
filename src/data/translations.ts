...
export const TRANSLATIONS: Record<LanguageCode, TranslationSchema> = {
  ...
  ar: {
    ...
    rfq: {
      ...
      disclaimer: 'اتصال مباشر بمكتب التجارة الرسمي لشركة جايد سينامون لانكا (+94 76 533 5308). رد رسمي فوري مع فاتورة أولية.',
    },
    quality: {
  ...
  de: {
    ...
    rfq: {
      ...
      disclaimer: 'Direkte Verbindung zum offiziellen Trade Desk von Jade Cinnamon Lanka (+94 76 533 5308).',
    },
    quality: {
