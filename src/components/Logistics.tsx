    ...
    <div className="relative w-full mb-16 sm:mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-3 mb-5 sm:mb-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#f6ecd6] dark:bg-[#C87A28]/20 border border-[#C87A28]/30 dark:border-[#C87A28]/40 flex items-center justify-center text-[#B86B1E] dark:text-amber-300 shadow-md">
                <Award className="w-6 h-6 sm:w-7 sm:h-7 text-[#B86B1E] dark:text-amber-300" />
              </div>
              <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-jade-950/90 border border-emerald-600/30 dark:border-jade-400/40 text-emerald-800 dark:text-jade-300 text-xs font-mono font-bold uppercase tracking-wider">
                Cinnamomum Verum
              </span>
            </div>

            <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#11281E] dark:text-white mb-3 group-hover:text-[#B86B1E] dark:group-hover:text-amber-200 transition-colors">
              {content.originTitle}
            </h3>
            <p className="text-[#536B5C] dark:text-gray-200 text-xs sm:text-sm md:text-base leading-relaxed mb-6">
              {content.originDesc} Sourced exclusively from private estates across Galle, Matara, and Ratnapura in Sri Lanka.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 pt-4 border-t border-[#E5D8C5] dark:border-white/10">
              <div className="flex items-center gap-2 text-xs text-[#11281E] dark:text-gray-200">
                <CheckCircle2 className="w-4 h-4 text-[#B86B1E] dark:text-amber-400 shrink-0" />
          ...
          <div className="mt-6 sm:mt-8 pt-4 border-t border-[#E5D8C5] dark:border-white/5 flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono text-[#B86B1E] dark:text-ceylon-300">
            <span>Sri Lanka EDB Verified Origin</span>
            <span className="text-[#536B5C] dark:text-gray-400">Direct Port of Colombo Export</span>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative lg:col-span-5 rounded-3xl p-5 sm:p-8 md:p-9 bg-white/95 dark:bg-[#0A2F22]/90 border border-[#E5D8C5] dark:border-ceylon-500/35 hover:border-[#C87A28]/60 dark:hover:border-ceylon-400/60 shadow-lg dark:shadow-2xl dark:shadow-black/80 flex flex-col justify-between overflow-hidden group gpu-accelerate backdrop-blur-md"
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-3 mb-5 sm:mb-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-emerald-50 dark:bg-jade-900/60 border border-emerald-600/30 dark:border-jade-400/40 flex items-center justify-center text-emerald-800 dark:text-jade-300 shadow-md">
                <FileCheck2 className="w-6 h-6 sm:w-7 sm:h-7 text-emerald-700 dark:text-jade-400" />
              </div>
              <span className="px-3 py-1 rounded-full bg-[#f6ecd6] dark:bg-black/60 border border-[#E5D8C5] dark:border-white/10 text-[#B86B1E] dark:text-amber-300 text-xs font-mono font-bold">
                ISO & SLS Accredited
              </span>
            </div>
            ...
            <p className="text-[#536B5C] dark:text-gray-200 text-xs sm:text-sm leading-relaxed mb-6">
              {content.certDesc}
            </p>

            <div className="grid grid-cols-2 gap-2.5">
              <div className="p-3 rounded-xl bg-[#F4EFE6] dark:bg-black/50 border border-[#E5D8C5] dark:border-white/10">
                <div className="text-xs font-bold text-[#11281E] dark:text-white">ISO 6539:2014</div>
                <div className="text-[10px] text-[#536B5C] dark:text-gray-400">Global Spice Standard</div>
              </div>
              <div className="p-3 rounded-xl bg-[#F4EFE6] dark:bg-black/50 border border-[#E5D8C5] dark:border-white/10">
                <div className="text-xs font-bold text-[#11281E] dark:text-white">SLS 81:2000</div>
                <div className="text-[10px] text-[#536B5C] dark:text-gray-400">National Standard</div>
              </div>
              <div className="p-3 rounded-xl bg-[#F4EFE6] dark:bg-black/50 border border-[#E5D8C5] dark:border-white/10">
                <div className="text-xs font-bold text-[#11281E] dark:text-white">USDA Organic</div>
                <div className="text-[10px] text-[#536B5C] dark:text-gray-400">Bio-Certified Batches</div>
              </div>
              <div className="p-3 rounded-xl bg-[#F4EFE6] dark:bg-black/50 border border-[#E5D8C5] dark:border-white/10">
                <div className="text-xs font-bold text-[#11281E] dark:text-white">GMP & HACCP</div>
                <div className="text-[10px] text-[#536B5C] dark:text-gray-400">Food Safety Compliant</div>
              </div>
            </div>
          </div>

          <div className="mt-6 pt-4 border-t border-[#E5D8C5] dark:border-white/5 text-[11px] text-[#536B5C] dark:text-gray-400 flex items-center gap-1.5">
            <ShieldCheck className="w-4 h-4 text-emerald-700 dark:text-jade-400 shrink-0" />
        ...
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-3 mb-5 sm:mb-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#f6ecd6] dark:bg-[#C87A28]/20 border border-[#C87A28]/30 dark:border-[#C87A28]/40 flex items-center justify-center text-[#B86B1E] dark:text-amber-300 shadow-md">
                <TreePine className="w-6 h-6 sm:w-7 sm:h-7 text-[#B86B1E] dark:text-amber-300" />
              </div>
              <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-black/60 border border-emerald-600/30 dark:border-white/10 text-emerald-800 dark:text-jade-300 text-xs font-mono font-bold">
                Single Estate Chain
              </span>
            </div>
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#F4EFE6] dark:bg-black/40 border border-[#E5D8C5] dark:border-white/5 text-xs text-[#11281E] dark:text-gray-200">
                <span className="text-[#536B5C] dark:text-gray-400">Annual Harvest Capacity:</span>
                <span className="font-bold text-[#B86B1E] dark:text-amber-300 font-mono">1,200+ Metric Tons</span>
              </div>
              <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#F4EFE6] dark:bg-black/40 border border-[#E5D8C5] dark:border-white/5 text-xs text-[#11281E] dark:text-gray-200">
                <span className="text-[#536B5C] dark:text-gray-400">Handcrafted Layering:</span>
                <span className="font-bold text-[#11281E] dark:text-white">Generational Peelers</span>
              </div>
            </div>
          </div>

          <div className="mt-6 pt-4 border-t border-[#E5D8C5] dark:border-white/5 text-[11px] text-[#536B5C] dark:text-gray-400 flex items-center gap-1.5">
            <Globe2 className="w-4 h-4 text-[#B86B1E] dark:text-ceylon-400 shrink-0" />
        ...
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-3 mb-5 sm:mb-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-emerald-50 dark:bg-jade-900/60 border border-emerald-600/30 dark:border-jade-400/40 flex items-center justify-center text-emerald-800 dark:text-jade-300 shadow-md">
                <Activity className="w-6 h-6 sm:w-7 sm:h-7 text-emerald-700 dark:text-jade-300" />
              </div>
            ...
            <div className="p-4 rounded-2xl bg-[#F4EFE6] dark:bg-black/60 border border-[#E5D8C5] dark:border-white/10 space-y-3">
              <div className="flex items-center justify-between text-xs">
                <span className="font-bold text-emerald-800 dark:text-jade-300">Jade Pure Ceylon Cinnamon:</span>
              ...
              <div className="flex items-center justify-between text-xs pt-1 border-t border-black/5 dark:border-white/5">
                <span className="text-[#536B5C] dark:text-gray-400">Cassia Cinnamon (Adulterant):</span>
          ...
          <div className="mt-6 pt-4 border-t border-[#E5D8C5] dark:border-white/5 text-[11px] text-[#536B5C] dark:text-gray-400 flex flex-wrap items-center justify-between gap-2">
            <span>EU & US FDA Dietary Compliance Approved</span>
            <span className="text-[#B86B1E] dark:text-amber-300 font-mono">1,250x Safer Than Cassia</span>
          </div>
        </motion.div>
      </div>
    </div>
...
export const Logistics: React.FC<LogisticsProps> = ({ t, currentLang = 'en', isRtl = false }) => {
  ...
  return (
    <section
      ref={sectionRef}
      id="logistics"
      className="relative w-full py-24 sm:py-28 overflow-hidden border-t border-[#E5D8C5] dark:border-ceylon-500/20 bg-[#FBF8F2] dark:bg-[#062319] scroll-mt-20 transition-colors duration-300"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
          className="text-center max-w-3xl mx-auto mb-14 pt-10 border-t border-[#E5D8C5] dark:border-white/10 gpu-accelerate"
        >
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-white/90 dark:bg-black/70 backdrop-blur-md border border-[#E5D8C5] dark:border-ceylon-500/40 text-[#B86B1E] dark:text-ceylon-300 text-xs font-bold tracking-wider uppercase mb-3 shadow-md">
            <Ship className="w-3 h-3 text-[#B86B1E] dark:text-ceylon-400" />
            <span>{t.logistics.badge}</span>
          </span>
          <h3 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-[#11281E] dark:text-white mb-4 tracking-tight drop-shadow-sm">
            {t.logistics.title}
          </h3>
          ...
          {cards.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                className="relative glass-card p-5 sm:p-6 rounded-2xl border border-[#E5D8C5] dark:border-ceylon-500/30 bg-white/95 dark:bg-[#0A2F22]/85 backdrop-blur-md shadow-lg dark:shadow-2xl flex flex-col justify-between group hover:border-[#C87A28]/60 dark:hover:border-amber-400/50 gpu-accelerate"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-bold text-emerald-800 dark:text-jade-300 uppercase tracking-wider bg-emerald-50 dark:bg-jade-950/90 px-2 py-1 rounded border border-emerald-600/30 dark:border-jade-500/40">
                      {card.tag}
                    </span>
                  </div>
                  <h4 className="font-serif text-xl font-bold text-[#11281E] dark:text-white mb-2 group-hover:text-[#B86B1E] dark:group-hover:text-amber-200 transition-colors">
                    {card.title}
                  </h4>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#f6ecd6] dark:bg-ceylon-500/25 border border-[#C87A28]/30 dark:border-ceylon-500/50 flex items-center justify-center shrink-0 shadow-md">
              <Anchor className="w-6 h-6 sm:w-7 sm:h-7 text-[#B86B1E] dark:text-ceylon-300" />
            </div>
            <div>
              <h4 className="font-serif text-lg sm:text-xl font-bold text-[#11281E] dark:text-white mb-1">
                Port of Colombo Direct Maritime Dispatch
              </h4>
              <p className="text-xs sm:text-sm text-[#536B5C] dark:text-gray-200">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-xl bg-[#F4EFE6] dark:bg-black/60 border border-[#E5D8C5] dark:border-ceylon-500/40 text-xs font-semibold text-[#B86B1E] dark:text-ceylon-300">
              <Clock className="w-4 h-4 text-[#B86B1E] dark:text-ceylon-400" />
