                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {items.map((item) => (
                      <div
                        key={item.id}
                        className="p-3.5 rounded-2xl bg-white dark:bg-[#082b20] border border-[#C87A28]/20 dark:border-[#C87A28]/30 shadow-md flex flex-col gap-3"
                      >
                        ...
                        <div className="flex items-center justify-between gap-2 pt-2 border-t border-[#C87A28]/20 dark:border-white/10">
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="min-w-[36px] min-h-[36px] flex items-center justify-center rounded-lg bg-[#F4EFE6] dark:bg-black/40 border border-[#C87A28]/20 dark:border-white/10 text-[#11281E] dark:text-[#F9F6F0] hover:bg-[#ebd7ad] dark:hover:bg-white/10 cursor-pointer"
                            ...
                            <input
                              ...
                              className="w-16 sm:w-20 text-center py-1.5 min-h-[36px] rounded-lg bg-[#F4EFE6] dark:bg-black/60 border border-[#C87A28]/20 dark:border-white/15 text-xs font-bold text-[#11281E] dark:text-[#F9F6F0] font-mono focus:outline-none"
                            />
                          ...
                          <div className="flex items-center gap-1">
                            {(['Kg', 'MT', 'L', 'Bales'] as const).map((unitOption) => (
                              <button
                                ...
                                className={`px-2 py-1 min-h-[36px] rounded-md text-[10px] font-bold uppercase transition-all cursor-pointer ${
                                  item.unit === unitOption
                                    ? 'bg-[#C87A28] text-white shadow-sm'
                                    : 'bg-[#F4EFE6] dark:bg-black/40 text-[#5A6D62] dark:text-[#A3B899] hover:text-black dark:hover:text-white border border-[#C87A28]/10'
                                }`}
                              >
                                {unitOption}
                              </button>
